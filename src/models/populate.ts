    ...
    },
    {
      ...
      progressions: [
        [
          ...
          ["typewriter-pullup", null, null],
          ["weighted-shrimp-squat", null, null],
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      progressions: [
        [
          ...
          ["nordic-curl", null, null, "eccentric-single-leg-hamstring-slide"],
          [null, null, null, "single-leg-hamstring-slide"],
        ],
      ],
    },
    {
      ...
      progressions: [
        [
          ...
          "horizontal-row",
          "wide-row",
          ["weighted-inverted-row", "tuck-front-lever", "archer-row"],
          [null, "tuck-front-lever-pull", "one-arm-row"],
          [null, "advanced-tuck-front-lever", null],
          [null, "advanced-tuck-front-lever-pull", null],
          [null, "half-straddle-front-lever", null],
          [null, "half-straddle-front-lever-pull", null],
          [null, "straddle-front-lever", null],
          [null, "straddle-front-lever-pull", null],
          [null, "half-lay-front-lever", null],
          [null, "half-lay-front-lever-pull", null],
          [null, "full-lay-front-lever", null],
          [null, "full-lay-front-lever-pull", null],
        ],
      ],
    },
    {
      ...
      progressions: [
        [
          ...
          "pushup",
          "diamond-pushup",
          ["pseudo-planche-pushup", "rings-pushup"],
          [null, "rto-pushup"],
        ],
      ],
    },
    {
      ...
      progressions: [
        [
          ...
          [null, "standing-ab-wheel-rollout", "pike-hanging-leg-raise", null],
          [null, null, "straight-hanging-leg-raise", null],
        ],
      ],
    },
    {
      ...
      progressions: [
        [
          ...
          [null, "knee-copenhagen-plank", null],
          [null, "assisted-copenhagen-plank", null],
          [null, "copenhagen-plank", null],
          [null, "copenhagen-plank-with-movement", null],
        ],
      ],
    },
    {
      ...
      progressions: [
        [
          ["reverse-hyperextension", "arch-raise", "hyper-extension"],
          [null, "arch-body-hold", null],
          [null, "arch-body-rocks", null],
        ],
      ],
    },
  ]);
